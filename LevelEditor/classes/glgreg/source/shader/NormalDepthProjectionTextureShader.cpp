#include "../../header/shader/NormalDepthProjectionTextureShader.h"

NormalDepthProjectionTextureShader::NormalDepthProjectionTextureShader()
{
	shaderType = SHADER_TYPE_NORMAL_DEPTH_PROJECTION_TEXTURE;

	addMain(SHADER_SOURCE_NORMAL_DEPTH_PROJECTION_TEXTURE_VERT, __shaderLinesVert);
	...
	addMain(SHADER_SOURCE_NORMAL_DEPTH_PROJECTION_TEXTURE_GEOM, __shaderLinesGeom);
	include(SHADER_MATRIX_UTILS, __shaderLinesGeom);

	addMain(SHADER_SOURCE_NORMAL_DEPTH_PROJECTION_TEXTURE_FRAG, __shaderLinesFrag);
...
void NormalDepthProjectionTextureShader::render()
{

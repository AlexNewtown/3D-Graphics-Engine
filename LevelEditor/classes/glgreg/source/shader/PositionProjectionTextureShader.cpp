#include "../../header/shader/PositionProjectionTextureShader.h"

PositionProjectionTextureShader::PositionProjectionTextureShader()
{
	shaderType = SHADER_TYPE_POSITION_PROJECTION_TEXTURE;

	addMain(SHADER_SOURCE_POSITION_PROJECTION_TEXTURE_VERT, __shaderLinesVert);
	...
	addMain(SHADER_SOURCE_POSITION_PROJECTION_TEXTURE_GEOM, __shaderLinesGeom);
	include(SHADER_MATRIX_UTILS, __shaderLinesGeom);

	addMain(SHADER_SOURCE_POSITION_PROJECTION_TEXTURE_FRAG, __shaderLinesFrag);
...
void PositionProjectionTextureShader::render()
{
